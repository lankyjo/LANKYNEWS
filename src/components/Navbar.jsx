...
const Navbar = ({setCategory, setTitle}) => {
    ...
    let local = `http://api.mediastack.com/v1/news?access_key=${import.meta.env.VITE_API_KEY}&categories=general&languages=en&countries=ng`;
    let crypto = `http://api.mediastack.com/v1/news?access_key=${import.meta.env.VITE_API_KEY}&keywords=crypto&languages=en`;
    let sports = `http://api.mediastack.com/v1/news?access_key=${import.meta.env.VITE_API_KEY}&categories=sports&languages=en`;
  return (
